...
const clientSchema = new mongoose.Schema(
  {
    ...
    wishlist: [wishlistSchema], // Array of wishlist items using the wishlistSchema defined above
    isActive: { type: Boolean, default: true },
    role: { // Enum for role with default value
      type: String,
      required: true,
      enum: ["client", "artisan"],
      default: "client",
  ...
  { timestamps: { createdAt: "registrationDate", updatedAt: "lastUpdate" } }
); // Add timestamps for registration and last update
