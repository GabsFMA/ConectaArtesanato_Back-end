...
const reviewSchema = new mongoose.Schema({
  ...
  comment: { type: String },
}, { timestamps: true }); // Add timestamps for review creation and updates
...
}, { timestamps: { createdAt: 'creationDate', updatedAt: 'lastUpdate' } }); // Add timestamps for creation and last update
